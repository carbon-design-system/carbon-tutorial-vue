<template>
    <div class="info-card bx--col-md-4 bx--col-lg-4 bx--col-xlg-3 bx--offset-xlg-1">
...
.info-card {
    ...
    .info-card__body {
        ...
        @include type-style('body-long-01'); // prevent large line lengths between small and medium viewports
