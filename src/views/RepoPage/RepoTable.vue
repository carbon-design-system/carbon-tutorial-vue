<template>
  <cv-data-table-skeleton
    ...
    :rows="10"
  />
  <cv-data-table v-else :columns="columns" :title="title" :helper-text="helperText" :pagination="{totalRows: Number, numberOfItems: this.totalRows }" @pagination="$emit('pagination', $event)">
    <template slot="data">
