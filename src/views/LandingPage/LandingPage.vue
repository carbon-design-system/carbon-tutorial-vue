<template>
  <div class="bx--grid bx--grid--full-width landing-page">
          ...
          <cv-tab label="About">
            <div class="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div class="bx--row landing-page__tab-content">
                ...
                <div class="bx--col bx--offset-lg-1 bx--col-lg-8">
                  <img
    ...
    <div class="bx--row landing-page__r3">
      ...
      <div class="bx--col">Carbon is Open</div>
      <div class="bx--col">Carbon is Modular</div>
      <div class="bx--col">Carbon is Consistent</div>
    </div>
  </div>
</template>
