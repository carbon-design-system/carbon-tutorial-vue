  ...
  <div class="bx--grid bx--grid--full-width landing-page">
    <div class="bx--row landing-page__banner">
      <div class="bx--col-lg-16">
        ...
        <h1 class="landing-page__heading">Desing &amp; build with Carbon</h1>
      </div>
    </div>
      ...
      <div class="bx--col bx--no-gutter">
        <cv-tabs selected="0" aria-label="Tab navigation">
            ...
            <div class="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div class="bx--row landing-page__tab-content">
                ...
                <div class="bx--col-md-4 bx--offset-lg-1 bx--col-lg-8">
                  <img src="../../assets/tab-illo.png" alt="Carbon illustration" class="landing-page__illo">
                </div>
              </div>
            </div>
          </cv-tab>
          <cv-tab label="Design">
            <div class="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div class="bx--row landing-page__tab-content">
                <div class="bx--col-md-4 bx--col-lg-16">Rapidly build beautiful and accessible experiences. The Carbon kit
              contains all resources you need to get started.</div>
              </div>
            </div>
          </cv-tab>
          <cv-tab label="Develop">
            <div class="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div class="bx--row landing-page__tab-content">
                <div class="bx--col-md-4 bx--col-lg-16">Carbon provides styles and components in Vanilla, Vue, Angular,
              and Vue for anyone building on the web.</div>
              </div>
            </div>
          </cv-tab>
        </cv-tabs>
