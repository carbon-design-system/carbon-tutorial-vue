            ...
            <div class="cds--grid cds--grid--no-gutter cds--grid--full-width">
              <div class="cds--row landing-page__tab-content">
                <div class="cds--col-md-4 cds--col-lg-7">
                  <h2 class="landing-page__subheading bx--type-semibold">
                    What is Carbon?
                  </h2>
...
@import './mixins';
@import 'carbon-components/scss/globals/scss/vendor/@carbon/type/scss/classes.scss';
// @import 'carbon-components/scss/globals/scss/vendor/@carbon/grid/scss/modules/_breakpoint.scss';
