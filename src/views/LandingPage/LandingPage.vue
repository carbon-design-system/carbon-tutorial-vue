  ...
  <div class="bx--grid bx--grid--full-width landing-page">
    ...
    <info-section heading="The Principles" class="landing-page__r3">
      <info-card
        ...
        body="It's ad distributed effort, guided by the principles of the open-source movement. Carbon's users are also it's makers, and everyone is encouraged to contribute."
